...
import { getCampaignsFullTable, getCampaignSummary, getRoasTimeSeries, getTopCreativesByRoas } from "@/lib/reports/campaigns";
...
export default async function CampaignsPage({
  ...
  const rows = campaignStatus
    ? allRows.filter((row) => row.unattributed || row.status === campaignStatus)
    : allRows;
